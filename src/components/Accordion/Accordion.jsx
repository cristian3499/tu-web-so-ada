        ...
        <>
            ...
            ${item.active === 1 ? 'is-active bg-white duration-500': '' } `}>
                <div className="flex items-center">
                    <div className="text-primary w-full duration-500 group-[.is-active]:font-bold">
                        {item.title}
                    </div>
                    <div className="text-primary text-xl rotate-90 duration-500 cursor-pointer group-[.is-active]:rotate-[270deg]"
